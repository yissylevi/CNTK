...
Note the provided data set has only 10.000 distinct words. This number is till not very high and sampled softmax doesn't show any significant per improvements here.
The real per gains will show up with larger vocabularies.
